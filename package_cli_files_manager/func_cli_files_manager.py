...
def help_reference(name2=None):
    comande_dict = {
        ...
        'findfile': 'ввод команды findfile-"findfile" "наименование папки поиска" "полное или частичное имя файла",\n' +
        'либо "наименование папки поиска" "полное или частичное имя файла" "размер файла до указанного в байтах",\n' +
        ' либо "наименование папки поиска" "полное или частичное имя файла" "размер файла от указанного в байтах"\n' +
        '"размер файла до указанного в байтах'}
    if name2 is None:
        string=('Команды используемые при работе с CLI_files_manager:\n"help"- выводит справочную информацию.\n"copy"-'
                ...
                '"findfile" - находит все файлы отвечающие  заданным параметрам поиска (по наименованию файла,части\n'+
                'наименования,размеру файла в байтах).\n' +
        ...
        if name2 in comande_dict.keys():
            ...
            string=(f'Ведённая команда {name2} не является командой CLI_files_manager. Поддерживаемые команды'
                    f' "copy, count, delete, help, test, findfile"')
            return string
